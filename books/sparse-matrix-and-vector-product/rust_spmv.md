...
そしてSpMM (疎行列-密行列積)のコードのある[このへんのディレクトリ](https://github.com/dimforge/nalgebra/tree/dev/nalgebra-sparse/src/ops)を見た限り並列化はされてません．
...
じゃあもっと面白い行列やれよって思うと思うんですが，正直なんか性能でなくて眠いし，5点中心差分の問題をCから吐き出してライブラリに食わせて答え合わせを書いて答え合わせを書く作業に4日もかかったのでこれ以上は今度ね．．．
